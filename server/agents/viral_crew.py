...
class ViralForgeAgentSystem:
    ...
    def _setup_knowledge(self) -> Knowledge:
        ...
        return Knowledge(
            sources=[
                "/home/omar/viralforge/knowledge/viral_patterns.md",
                "/home/omar/viralforge/knowledge/platform_guidelines.md",
                "/home/omar/viralforge/knowledge/content_strategies.md"
            ],
            embedder_config={
                "provider": "openai",
